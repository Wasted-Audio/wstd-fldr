...
protected:
    ...
    */
    void onImGuiDisplay() override
    {
        ...
        if (ImGui::Begin("WSTD FLDR", nullptr, ImGuiWindowFlags_NoResize + ImGuiWindowFlags_NoCollapse + ImGuiWindowFlags_NoScrollbar))
        {
